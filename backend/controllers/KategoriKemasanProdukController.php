...
use app\models\ProdukKemasanKtgSearch;
...
class KategoriKemasanProdukController extends Controller
{
    ...
    {
        $searchModel = new ProdukKemasanKtgSearch();
    ...
    {
        if (($model = ProdukKemasanKtg::findOne($id)) !== null) {
            return $model;
        } else {
