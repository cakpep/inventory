...
use app\models\TransaksiReturSearch;
...
class ReturTransaksiController extends Controller
{
    ...
    {
        $searchModel = new TransaksiReturSearch();
    ...
    {
        if (($model = TransaksiRetur::findOne(['transaksi_id' => $transaksi_id, 'produk_id' => $produk_id])) !== null) {
            return $model;
        } else {
