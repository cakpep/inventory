...
<?php Pjax::begin(['id' => 'customer-gridview']) ?> 
    <?= GridView::widget([
        'id'=>'customer-table-grid',
        ...
        'columns' => [
            ...
            [
                'attribute' => 'customer_ktg_id',
                'format'=>'raw',
                'filter'=>\app\models\Data::customerKtg(),
                'value' => function ($data){
                    $group = $data->customerKtg;                    
                    return  !empty($group) ? $group->nama :'-';
                }
            ],
            [
                'attribute' => 'sistem_kerja_sama_id',
                'format'=>'raw',
                'filter'=>\app\models\Data::customerSistemKerja(),
                'value' => function ($data){
                    $group = $data->sistemKerjaSama;                    
                    return  !empty($group) ? $group->type_kerjasama :'-';
                }
            ],
