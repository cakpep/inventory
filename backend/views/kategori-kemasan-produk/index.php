...
$this->title = 'Data Kategori Kemasan Produk';
...
<div class="produk-kemasan-ktg-index">
...
<?php Pjax::begin(['id' => 'produk-kemasan-ktg-gridview']) ?> 
    <?= GridView::widget([
        'id'=>'produk-kemasan-ktg-table-grid',
