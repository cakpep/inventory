...
$this->title = 'Data Produksi Karyawan';
...
<div class="produksi-karyawan-index">
...
<?php Pjax::begin(['id' => 'produksi-karyawan-gridview']) ?> 
    <?= GridView::widget([
        'id'=>'produksi-karyawan-table-grid',
        ...
        'columns' => [
            ...
            [
                'attribute' => 'produk_kemaasan_id',
                'format'=>'raw',
                'filter'=>\app\models\Data::produkKemasanKtg(),
                'value' => function ($data){
                    $group = $data->kemasan;                    
                    return  !empty($group) ? $group->upah :'-';
                }
            ],
            'tanggal',
            // 'created_by',
